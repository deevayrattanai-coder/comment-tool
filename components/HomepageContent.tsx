...
const platforms = [
  {
    slug: 'tiktok',
    name: 'TikTok',
    description: 'Video & reply comment templates with verified badges and engagement metrics.',
  ...
  },
  {
    slug: 'instagram',
    name: 'Instagram',
    description: 'Pixel-perfect Post and Reels comments with timestamps and like counts.',
  ...
  },
  {
    slug: 'youtube',
    name: 'YouTube',
    description: 'Video & Shorts threaded replies with like / dislike counts and verification.',
  ...
  },
  {
    slug: 'twitter',
    name: 'X (Twitter)',
    description: 'Authentic post replies with retweet, quote, and bookmark metrics.',
    ...
    <div className="bg-background border-t border-border">
      ...
      <section className="max-w-[1100px] mx-auto px-6 py-12">
        <div className="text-center mb-10">
          <span className="text-xs font-semibold uppercase tracking-widest text-primary">Pick a platform</span>
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-foreground mt-2 mb-3" style={{ textWrap: 'balance' }}>
            Generate platform-specific comments
          </h2>
          <p className="text-base text-muted-foreground max-w-[520px] mx-auto">
            Open a dedicated workspace for each social network and start exporting in seconds.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {platforms.map((p) => (
            ...
            >
              <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${p.color} text-white flex items-center justify-center shadow-md mb-4`}>
                {p.icon}
              </div>
              <h3 className="font-bold text-foreground text-base mb-1.5 group-hover:text-primary transition-colors">{p.name}</h3>
      ...
      <section className="max-w-[1100px] mx-auto px-6 pt-6 pb-16">
        <div className="grid md:grid-cols-3 gap-5">
          ...
          >
            <span className="text-[10px] font-bold uppercase tracking-widest text-primary">Power feature</span>
            <h3 className="font-bold text-foreground text-lg mt-1.5 mb-2">Bulk Generator</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Upload a CSV or Excel file with hundreds of comments and download every screenshot as a single ZIP.
            </p>
          </Link>
          <Link
            href="/pricing"
          ...
          >
            <span className="text-[10px] font-bold uppercase tracking-widest text-primary">Plans</span>
            <h3 className="font-bold text-foreground text-lg mt-1.5 mb-2">Pricing</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Free for occasional creators. Upgrade for unlimited exports and bulk generation.
            </p>
          </Link>
          <Link
            href="/profile"
            className="rounded-2xl border border-border bg-card p-6 hover:shadow-md transition-all"
          >
            <span className="text-[10px] font-bold uppercase tracking-widest text-primary">Account</span>
            <h3 className="font-bold text-foreground text-lg mt-1.5 mb-2">Your profile</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              View your export history, manage your password, and check usage against your plan limits.
            </p>
          </Link>
        </div>
      </section>
