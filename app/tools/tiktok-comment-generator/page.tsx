...
export const metadata = createMetadata({
  ...
  path: "/tools/tiktok-comment-generator",
});

export default async function TiktokCommentGenerator() {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Navbar />
      <CommentTool initialPlatform={"tiktok"} />

      {"tiktok-comment-generator" === "tiktok-comment-generator" && (
        ...
        <div className="max-w-[1100px] mx-auto px-6 py-12 md:py-16">
          ...
          <div className="w-full">
            ...
            <p className="mt-4 text-muted-foreground text-sm md:text-base leading-relaxed">
              In today’s competitive social media landscape, engagement plays a
              crucial role. For example, top creators like Charli D'Amelio and
              Khaby Lame consistently attract attention through high interaction
              on their posts.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-10">
            ...
            <div className="flex gap-3 p-4 rounded-xl border border-border bg-background/60 backdrop-blur hover:shadow-sm transition">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Make your posts look active and increase perceived interaction
                  instantly.
                </p>
              </div>
            </div>
      ...
      <section className="border-b border-border bg-gradient-to-b from-background to-primary/5">
        <div className="max-w-[1100px] mx-auto px-6 py-12 md:py-16">
          ...
          <div className="w-full">
            ...
            <h2 className="text-2xl md:text-4xl font-extrabold tracking-tight text-foreground mt-2">
              Key Features of Our tiktok comment generator tool
            </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
            ...
            <div className="p-5 rounded-2xl border border-border bg-background/70 backdrop-blur hover:shadow-md transition">
              ...
              <p className="text-sm text-muted-foreground">
                Generate comments that mimic real tiktok interactions, including
      ...
      <section className="bg-gradient-to-b from-background to-primary/5">
        <div className="max-w-[1100px] mx-auto px-6 py-12 md:py-16 text-center">
          ...
          <p className="mt-4 w-full mx-auto text-sm md:text-base text-muted-foreground leading-relaxed">
            In short, tiktok comment generator can help you build all comment
            sections that are magical, real, and entertaining and we are
            absolutely confident that this is the Best tiktok Comment Generator
